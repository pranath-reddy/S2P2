...
Code to plot the confusion matrices for Multi-class classification
'''
...
conf_matrix = np.array([[ 168,  226,   35],
                        [ 113, 5540,  104],
                        [  21,  133, 1095]])

# Define the classes (labels) of the confusion matrix
classes = ['hate speech', 'offensive language', 'neither as positive or negative']
...
plt.savefig('conf_mat_DBERT.png', dpi=300)
